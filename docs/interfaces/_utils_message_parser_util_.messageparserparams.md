[node-input-validator](../README.md) › [Globals](../globals.md) › ["utils/message-parser.util"](../modules/_utils_message_parser_util_.md) › [MessageParserParams](_utils_message_parser_util_.messageparserparams.md)
