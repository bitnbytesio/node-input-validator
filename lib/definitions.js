...
var rules = [{
  ...
  description: 'The field under validation must be accepted if the provided' + 'field value is equals to provided value.',
  types: ALL
}, {
  name: 'acceptedNotIf',
  arguments: [{
  ...
  description: 'The field under validation must not be accepted if the provided' + 'field value is equals to provided value..',
  types: ALL
}, {
  name: 'alpha',
  arguments: [],
  ...
  arguments: [{
    type: 'enum',
    name: 'formatting',
    options: ['YYYY', 'YYYY-MM', 'YYYY-MM-DD', 'YYYY-MM-DDThh:mmTZD', 'YYYY-MM-DDThh:mm:ssTZD', 'YYYY-MM-DDThh:mm:ss.sTZD']
  }],
