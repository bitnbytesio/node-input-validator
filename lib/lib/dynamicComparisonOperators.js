...
function percentageRuleComparison(operation, percentage, fieldValue, relatedPropertyValue) {
  ...
  var relatedPropertyValueComparator = relatedPropertyValue * percentage.slice(0, percentage.length - 1) / 100;
  return dynamicComparisonOperators(operation, fieldValue, relatedPropertyValueComparator);
}

module.exports = {
  dynamicComparisonOperators: dynamicComparisonOperators,
  percentageRuleComparison: percentageRuleComparison
};