 ...
 * ```
 */
export function accepted(args = ["true", "1", "yes", "on"]) {
    return {
        name: "accepted",
        handler: (value) => {
...
* ```
*/
export function acceptedIf(args, acceptedValues = ["true", "1", "yes", "on"]) {
...
* ```
*/
export function acceptedNotIf(args, acceptedValues = ["true", "1", "yes", "on"]) {
    const argsLen = args.length;
    if (!args
        || argsLen < 2
        || argsLen % 2 !== 0) {
