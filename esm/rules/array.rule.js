 ...
 * @param args seeds
 */
export function arrayUniqueObjects(args) {
    return {
 ...
 * @param args seeds
 */
export function arrayLenRange(args) {
 ...
 * @param args seeds
 */
export function arrayLenMin(args) {
    if (args.length !== 1) {
        throw new Error('Invalid number of arguments.');
    }
 ...
 * @param args seeds
 */
export function arrayLenMax(args) {
    if (args.length !== 1) {
        throw new Error('Invalid number of arguments.');
    }
    const max = parseInt(args[0], 10);
